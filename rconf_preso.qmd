...
:::{.fragment}
![](imgs/emoji_think.png){.absolute bottom=50 right=675 width="250" height="250"}
:::
:::{.fragment}
![](imgs/emoji_omg.png){.absolute bottom=50 right=375 width="250" height="250"}
:::
:::{.fragment}
![](imgs/emoji_nerd.png){.absolute bottom=50 right=75 width="250" height="250"}
:::
...
palmerpenguins::penguins %>%
  group_by(species) %>%
  summarise(across(starts_with('fli'), ~ mean(.x, na.rm = TRUE))) %>%
