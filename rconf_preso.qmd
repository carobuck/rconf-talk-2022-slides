...
:::{.fragment}
![](imgs/emoji_think.png){.absolute bottom="17%" right=725 width="275" height="275"}
:::
:::{.fragment}
![](imgs/emoji_omg.png){.absolute bottom="17%" right=400 width="275" height="275"}
:::
:::{.fragment}
![](imgs/emoji_nerd.png){.absolute bottom="17%" right=75 width="275" height="275"}
:::
...
![](imgs/emoji_party.png){.absolute top="45%" right="5%" width="350" height="350"}

::: {.notes}
YOU'RE INVITED! we're all at the biggest data party there is, but I'm formally inviting you to another. 
...
## {background-image="imgs/Why_Blank.png"}

::: {.column width="50%"}
::: {.fragment .semi-fade-out .absolute top="10%" width="50%"}
